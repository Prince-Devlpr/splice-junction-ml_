...
# =========================
# 4) K-mer features only for PCA visualization
# =========================
...
# =========================
# 6) Simple encoding for training (without feature extraction)
# =========================
X = np.array([[mapping.get(c, 0) for c in seq] for seq in sequences])
...
print("KBANN WITHOUT Feature Extraction Accuracy:", accuracy)

# =========================
# 7) Accuracy graph
# =========================
plt.bar(["KBANN Without Feature"], [accuracy], color="tomato")
